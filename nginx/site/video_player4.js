...
function processConfig(config)
{
    ...
    <source type="application/x-mpegURL" label="auto" selected="true" id="1vidauto">
    <source type="application/x-mpegURL" label="480" res="480" id="1vid480"></source>
    */
   /*
    var vid_prew = document.getElementById("previewPlayer0");
    var src = document.createElement('source');
    src.setAttribute('src',config[0].vid_auto);
    src.setAttribute('type',"application/x-mpegURL");
    vid_prew.appendChild(src);


    var vid = document.getElementById("hlsPlayer0");
    var src = document.createElement('source');
    src.setAttribute('src',config[0].vid_auto);
    src.setAttribute('type',"application/x-mpegURL");
    src.setAttribute('label',"auto");
    src.setAttribute('selected',"true");
    src.setAttribute('id',"0vidauto");
    vid.appendChild(src);

    var vid = document.getElementById("hlsPlayer0");
    var src = document.createElement('source');
    src.setAttribute('src',config[0].vid_480);
    src.setAttribute('type',"application/x-mpegURL");
    src.setAttribute('label',"480");
    src.setAttribute('id',"0vid480");
    vid.appendChild(src);

    var vid = document.getElementById("hlsPlayer0");
    var src = document.createElement('source');
    src.setAttribute('src',config[0].vid_360);
    src.setAttribute('type',"application/x-mpegURL");
    src.setAttribute('label',"360");
    src.setAttribute('id',"0vid360");
    vid.appendChild(src);


    var vid = document.getElementById("hlsPlayer0");
    var src = document.createElement('source');
    src.setAttribute('src',config[0].vid_240);
    src.setAttribute('type',"application/x-mpegURL");
    src.setAttribute('label',"240");
    src.setAttribute('id',"0vid240");
    vid.appendChild(src);
////
    var vid_prew = document.getElementById("previewPlayer1");
    var src = document.createElement('source');
    src.setAttribute('src',config[1].vid_auto);
    src.setAttribute('type',"application/x-mpegURL");
    vid_prew.appendChild(src);


    var vid = document.getElementById("hlsPlayer1");
    var src = document.createElement('source');
    src.setAttribute('src',config[1].vid_auto);
    src.setAttribute('type',"application/x-mpegURL");
    src.setAttribute('label',"auto");
    src.setAttribute('selected',"true");
    src.setAttribute('id',"1vidauto");
    vid.appendChild(src);

    var vid = document.getElementById("hlsPlayer1");
    var src = document.createElement('source');
    src.setAttribute('src',config[1].vid_480);
    src.setAttribute('type',"application/x-mpegURL");
    src.setAttribute('label',"480");
    src.setAttribute('id',"1vid480");
    vid.appendChild(src);

    var vid = document.getElementById("hlsPlayer1");
    var src = document.createElement('source');
    src.setAttribute('src',config[1].vid_360);
    src.setAttribute('type',"application/x-mpegURL");
    src.setAttribute('label',"360");
    src.setAttribute('id',"1vid360");
    vid.appendChild(src);


    var vid = document.getElementById("hlsPlayer0");
    var src = document.createElement('source');
    src.setAttribute('src',config[1].vid_240);
    src.setAttribute('type',"application/x-mpegURL");
    src.setAttribute('label',"240");
    src.setAttribute('id',"1vid240");
    vid.appendChild(src);
//////////
var vid_prew = document.getElementById("previewPlayer2");
var src = document.createElement('source');
src.setAttribute('src',config[2].vid_auto);
src.setAttribute('type',"application/x-mpegURL");
vid_prew.appendChild(src);


var vid = document.getElementById("hlsPlayer2");
var src = document.createElement('source');
src.setAttribute('src',config[2].vid_auto);
src.setAttribute('type',"application/x-mpegURL");
src.setAttribute('label',"auto");
src.setAttribute('selected',"true");
src.setAttribute('id',"2vidauto");
vid.appendChild(src);

var vid = document.getElementById("hlsPlayer2");
var src = document.createElement('source');
src.setAttribute('src',config[2].vid_480);
src.setAttribute('type',"application/x-mpegURL");
src.setAttribute('label',"480");
src.setAttribute('id',"2vid480");
vid.appendChild(src);

var vid = document.getElementById("hlsPlayer2");
var src = document.createElement('source');
src.setAttribute('src',config[2].vid_360);
src.setAttribute('type',"application/x-mpegURL");
src.setAttribute('label',"360");
src.setAttribute('id',"2vid360");
vid.appendChild(src);


var vid = document.getElementById("hlsPlayer2");
var src = document.createElement('source');
src.setAttribute('src',config[2].vid_240);
src.setAttribute('type',"application/x-mpegURL");
src.setAttribute('label',"240");
src.setAttribute('id',"2vid240");
vid.appendChild(src);
///
var vid_prew = document.getElementById("previewPlayer3");
var src = document.createElement('source');
src.setAttribute('src',config[3].vid_auto);
src.setAttribute('type',"application/x-mpegURL");
vid_prew.appendChild(src);


var vid = document.getElementById("hlsPlayer3");
var src = document.createElement('source');
src.setAttribute('src',config[3].vid_auto);
src.setAttribute('type',"application/x-mpegURL");
src.setAttribute('label',"auto");
src.setAttribute('selected',"true");
src.setAttribute('id',"3vidauto");
vid.appendChild(src);

var vid = document.getElementById("hlsPlayer3");
var src = document.createElement('source');
src.setAttribute('src',config[3].vid_480);
src.setAttribute('type',"application/x-mpegURL");
src.setAttribute('label',"480");
src.setAttribute('id',"3vid480");
vid.appendChild(src);

var vid = document.getElementById("hlsPlayer3");
var src = document.createElement('source');
src.setAttribute('src',config[3].vid_360);
src.setAttribute('type',"application/x-mpegURL");
src.setAttribute('label',"360");
src.setAttribute('id',"3vid360");
vid.appendChild(src);


var vid = document.getElementById("hlsPlayer3");
var src = document.createElement('source');
src.setAttribute('src',config[3].vid_240);
src.setAttribute('type',"application/x-mpegURL");
src.setAttribute('label',"240");
src.setAttribute('id',"3vid240");
vid.appendChild(src);
*/
    var vid_src = document.getElementById("previewPlayer0_src");
    ...
    var vid_src = document.getElementById("previewPlayer1_src");
    ...
    var vid_src = document.getElementById("previewPlayer2_src");
    ...
    var vid_src = document.getElementById("previewPlayer3_src");
    vid_src.setAttribute('src',config[2].vid_auto);
...
function refreshCameras() {
    ...
    $('#thumbnail2').attr('src', function(i, old) { return old.replace(/\?.+/,"?i=" + (Date.now)); });
    $('#thumbnail3').attr('src', function(i, old) { return old.replace(/\?.+/,"?i=" + (Date.now)); });
